      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          try {
            ...
            if (m.limit) m.reply(+ m.limit + ' Limits apply')
          }
          break
        }
      }
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'This command can only be used by Chintu, CEO of WhiteHatJr 🌝',
    owner: 'This command can only be used by Chintu, CEO of WhiteHatJr 🌝',
    ...
    unreg: 'Please register to use this feature by typing: \ n \ n * # list name. age * \ n \ nExample: * # Human list.16 *'
